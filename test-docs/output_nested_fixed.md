...
| ----------------- | ---------------------------------------------------------------------- | --------------------- |
| Extraction Engine | Primary: Pandoc (HTML mode)<br>Fallback: MarkItDown<br>Legacy: Docling | Configured per router |
...
| --------------------------------- | --------------------------------------------------------- |
| [Table: A \| B / 1 \| 2 / 3 \| 4] | To the left is a nested table inside an outer table cell. |
