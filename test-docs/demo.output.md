...
| [Table: One Three \| Two / One Three \| Four] | To the left is a table inside a table, with some cells merged. |
| --------------------------------------------- | -------------------------------------------------------------- |
...
Footnotes[1](#fn1) and endnotes[2](#fn2) are automatically recognized and both are converted to endnotes, with backlinks for maximum ease of use in ebook devices.
...
![dot_green.png](media/image2.png)![forward.png](media/image4.png)Centered images like this are useful for large pictures that should be a focus of attention.
...
1. In paged media, footnotes are usually displayed at the bottom of the text. However, in ebooks, a better paradigm is to make them clickable endnotes that the user can browse at her pleasure. This conversion is handled automatically by calibre.[↩︎](#fnref1)

2. Endnotes are typically used for longer notes, they remain endnotes when converted into ebook form, except that they have an additional backlink to make it easy to return to the current position after reading the note.[↩︎](#fnref2)
