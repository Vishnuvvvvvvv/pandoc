...
This table uses cell merging (colspan/rowspan). Pandoc cannot represent this in standard Markdown, so it will emit HTML \
**ANNUAL PRODUCT LIFECYCLE SUMMARY**
| Product Details | (Product Details) | Financial Performance | (Financial Performance) | Status |
| --- | --- | --- | --- | --- |
...
| Q1 Metrics | (Q1 Metrics) | (Q1 Metrics) | (Q1 Metrics) | Q2 Metrics | (Q2 Metrics) | (Q2 Metrics) | (Q2 Metrics) |
| --- | --- | --- | --- | --- | --- | --- | --- |
